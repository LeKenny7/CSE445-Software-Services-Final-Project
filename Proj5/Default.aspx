...
<cse:loginName runat = "server" />
    ...
    <p style="font-size: small">
        - Admin Page can only be accessed if logged in as <strong>Username</strong>: <em>TA</em> <strong>Password</strong>: &quot;<em>Cse445ta!</em>&quot;</p>
    <p style="font-size: small">
        - Members only have access to the Members page</p>
    <p style="font-size: small">
        - Staff has access to the Members and Staff pages</p>
    <p style="font-size: small">
        - Admin has access to all pages (Member, Staff, Admin)</p>
    <p style="font-size: small">
